        ...
        <nav className="nav inner">
            ...
            <div className="nav-right nav-menu">
                <div className="nav-item">
                    <div>
                        <button className="button is-success get-app">Get the app</button>
                        <button className="button is-danger web-app">Web apps for life!</button>
                    </div>
                </div>
                <div className="nav-item"><button className="button">Sign Up</button></div>
                <div className="nav-item"><button className="button">Log In</button></div>
            </div>
        </nav>
    </div>
);
